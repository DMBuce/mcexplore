...
If mcexplore is in your PATH, you run it from your server directory, there's
...
To do the same in a more verbose way,
 ...
 /path/to/mcexplore -p /path/to/server -c "java -jar minecraft_server.jar" -x 0 -z 0 63 63
